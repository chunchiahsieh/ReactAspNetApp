import styles from './AED_AD_S1IP_EM_CreateForm.module.scss';
import { useTranslation } from "react-i18next";
import { ESGForm } from "components";
import localeCommon from "styles/locales/common";
import dayjs from "dayjs";

export interface AED_AD_S1IP_EM_CreateFormProps {
  
}

export function AED_AD_S1IP_EM_CreateForm({}: AED_AD_S1IP_EM_CreateFormProps) {
  const [t, i18n] = useTranslation("common");  
  return (
    <ESGForm
        title={t(localeCommon.Funcation_id.AED_AD_S1IP_EM_CreateForm)}
        columns = {[          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Organizational_unit_ID), zh: t(localeCommon.OGHG_Industrial_process.Organizational_unit_ID) }//所屬組織單位
          , cType: "search" , value: "", required: true},           
          { name: { en: t(localeCommon.OGHG_Industrial_process.Facility_ID), zh: t(localeCommon.OGHG_Industrial_process.Facility_ID) }//所屬據點
          , cType: "search" , value: "",required: true},                      
          { name: { en: t(localeCommon.OGHG_Industrial_process.Name), zh: t(localeCommon.OGHG_Industrial_process.Name) }//排放名稱
          , cType: "text" , value: "", required: true, nCols: 1,fnType: "disable" },          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_type_ID), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_type_ID) }//製程類型
          , cType: "search" , value: "", required: true},                                 
            { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_type_Remarks), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_type_Remarks) }//製程類型備註
          , cType: "text" , value: "", required: false},          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Description), zh: t(localeCommon.OGHG_Industrial_process.Description) }//說明
          , cType: "text" , value: "", nCols: 1,required: false },
          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_material_type), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_material_type) }//原物料類型
          , cType: "search" , value: "", required: true},          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_material_type_Remarks), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_material_type_Remarks) }//原物料類型備註
          , cType: "text" , value: "", required: true}, 
          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_equipment_type), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_equipment_type) }//製程設備類型
          , cType: "search" , value: "", required: true},          
          { name: { en: t(localeCommon.OGHG_Industrial_process.Industrial_process_equipment_type_Remarks), zh: t(localeCommon.OGHG_Industrial_process.Industrial_process_equipment_type_Remarks) }//製程設備備註
          , cType: "text" , value: "", required: false}, 

          { name: { en: t(localeCommon.OGHG_Industrial_process.Methodology_type), zh: t(localeCommon.OGHG_Industrial_process.Methodology_type) }//計算方法          
