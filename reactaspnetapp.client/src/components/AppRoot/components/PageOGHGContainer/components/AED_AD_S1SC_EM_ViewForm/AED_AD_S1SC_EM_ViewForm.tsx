import styles from './AED_AD_S1SC_EM_ViewForm.module.scss';
import { useTranslation } from "react-i18next";
import { ESGForm } from "components";
import localeCommon from "styles/locales/common";
import dayjs from "dayjs";

export interface AED_AD_S1SC_EM_ViewFormProps {
  
}

export function AED_AD_S1SC_EM_ViewForm({}: AED_AD_S1SC_EM_ViewFormProps) {
  const [t, i18n] = useTranslation("common");
  return (
    <ESGForm
        title={t(localeCommon.Funcation_id.AED_AD_S1SC_EM_ViewForm)}
        columns = {[
