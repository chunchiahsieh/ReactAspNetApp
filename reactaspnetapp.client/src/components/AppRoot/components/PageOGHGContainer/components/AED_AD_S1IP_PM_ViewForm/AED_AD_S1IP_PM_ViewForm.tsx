import styles from './AED_AD_S1IP_PM_ViewForm.module.scss';
...
export interface AED_AD_S1IP_PM_ViewFormProps {
  
}

export function AED_AD_S1IP_PM_ViewForm({}: AED_AD_S1IP_PM_ViewFormProps) {
  const [t, i18n] = useTranslation("common");  
  return (
    <ESGForm
        title={t(localeCommon.Funcation_id.AED_AD_S1IP_PM_ViewForm)}
        columns = {[  
          ...
          { name: { en: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_type_ID), zh: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_type_ID) }//{ name: { en: "製程設備類型", zh: "製程設備類型" }
          , cType: "text" , value: "", required: true, fnType: "view"},                     
          { name: { en: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_type_Remarks), zh: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_type_Remarks) }//{ name: { en: "製程設備備註", zh: "製程設備備註" }
          ...
          { name: { en: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_equipment_type), zh: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_equipment_type) }//{ name: { en: "製程類型", zh: "製程類型" }
          , cType: "text" , value: "", required: true, fnType: "view"},
          { name: { en: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_equipment_type_Remarks), zh: t(localeCommon.OGHG_Industrial_process_PM.Industrial_process_equipment_type_Remarks) }//{ name: { en: "製程設備備註", zh: "製程設備備註" }
          , cType: "text" , value: "", required: false, fnType: "view"}, 
