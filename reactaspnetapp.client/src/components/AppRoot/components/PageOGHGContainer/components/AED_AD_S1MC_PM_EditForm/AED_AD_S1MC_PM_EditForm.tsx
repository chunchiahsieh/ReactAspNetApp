import styles from './AED_AD_S1MC_PM_EditForm.module.scss';
import { useTranslation } from "react-i18next";
import { ESGForm } from "components";
import localeCommon from "styles/locales/common";
import dayjs from "dayjs";

export interface AED_AD_S1MC_PM_EditFormProps {
  
}

export function AED_AD_S1MC_PM_EditForm({}: AED_AD_S1MC_PM_EditFormProps) {
  const [t, i18n] = useTranslation("common");
  return (
    <ESGForm
        title={t(localeCommon.Funcation_id.AED_AD_S1MC_PM_EditForm)}
        columns = {[
