...
import localeEFMEFL from 'styles/locales/EFMEFL';//多國語系檔案
import dayjs from "dayjs";


export interface EFM_EFL_CreateFormProps {
}

export function EFM_EFL_CreateForm({}: EFM_EFL_CreateFormProps) {
  const [t, i18n] = useTranslation(["EFMEFL","common"]);
  return (
    <ESGForm
        title={t(localeEFMEFL.vam.createFormTitle)}
        columns = {[            
