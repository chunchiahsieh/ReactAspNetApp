...
public partial class BdcFacilityReadDTO
{
...
public class BdcFacility2ReadDTOProfile : Profile
{
    public BdcFacility2ReadDTOProfile()
    {
        CreateMap<BdcFacility, BdcFacilityReadDTO>()
