...
public partial class SmEmissionFactorReadDTO
{
...
public class SmEmissionFactor2ReadDTOProfile : Profile
{
    public SmEmissionFactor2ReadDTOProfile()
    {

        CreateMap<SmEmissionFactor, SmEmissionFactorReadDTO>()
