...
public partial class SmEmissionFactorCreateDTO
{
...
public class CreateDTO2SmEmissionFactorProfile : Profile
{
    public CreateDTO2SmEmissionFactorProfile()
    {
        CreateMap<SmEmissionFactorCreateDTO, SmEmissionFactor>().ForAllMembers(opts => opts.Condition((src, dest, srcMember) => srcMember != null));
    }
}